...
## 📌 Proje Genel Bakışı
Bu çalışma, diyabet hastalığının erken teşhisi için makine öğrenmesi algoritmalarının performansını analiz eder. Veri seti üzerinde kapsamlı temizlik, tıbbi literatüre uygun yeni öznitelik türetme (Feature Engineering) ve hiperparametre optimizasyonu süreçlerini kapsar.
...
├── notebooks/          # Analiz ve modelleme (diabetMachine.ipynb)[cite: 1]
